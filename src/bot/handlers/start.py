...
HELP_TEXT = (
    ...
    "<b>🤖 AI takeover (бот ведёт чат за тебя)</b>\n"
    "/ai_on <code>имя [минут=30]</code> — включить AI на контакте. "
    "Если ты молчишь дольше N минут с момента входящего — бот сам отвечает, "
    "представляясь как твой AI-ассистент.\n"
    "/ai_off <code>имя</code> — выключить, отвечаешь сам.\n"
    "/ai_list — список контактов под AI takeover (с временем последнего ответа AI).\n"
    "Также есть кнопка <b>«🤖 AI ведёт чат»</b> в меню <code>/chat &lt;имя&gt;</code>.\n\n"
