...
| «Дай саммари по всем чатам за сутки» | Выжимка по топ-N активным личным чатам разом |
...
- `/all_summary [top_n] [часов]` — короткая выжимка по топ-N активным личным чатам разом (default: 10 чатов × 24ч)
...
│       ├── all_summary_cmd.py # /all_summary
│       ├── style_cmd.py     # /style
